// Ported from faithspark-web/src/constants/data.ts — SUDOKU_PUZZLES only
// (the easy/medium/hard puzzle + solution grids used by the Bible Sudoku game).
...
export type SudokuDifficulty = keyof typeof SUDOKU_PUZZLES;
