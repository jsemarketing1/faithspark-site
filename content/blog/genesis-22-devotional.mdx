...
image: "/blog/genesis-22-devotional.webp"
imageAlt: "A father and son walking together through an open landscape — trusting God with what you love most"
faqs:
  - question: "What is Genesis 22 about?"
    answer: "Genesis 22 is the story of God commanding Abraham to sacrifice his son Isaac on Mount Moriah — the son he had waited 25 years for. Abraham obeys, walking all the way to the moment of complete surrender, before God stops him and provides a ram in a thicket as a substitute. It is one of the most theologically significant and emotionally intense chapters in the entire Bible."
  - question: "Why did God ask Abraham to sacrifice Isaac?"
    answer: "The text tells us directly it was a test — to see if Abraham feared God more than he loved even the most precious gift God had given him. The deeper question God was asking: had the gift become more important than the Giver? Had the promise replaced the One who made the promise? Abraham's willingness to surrender Isaac proved that God was still genuinely first in his life."
  - question: "What does 'the Lord will provide' mean in Genesis 22:14?"
    answer: "'The Lord will provide' (Yahweh-Jireh in Hebrew) is what Abraham named the mountain after God provided the ram. It is a declaration based on personal experience that God prepares provision before we arrive at the moment we need it. The ram was already in the thicket before Abraham raised the knife. God's provision does not appear after we pass the test — it is prepared in advance."
  - question: "What does the story of Abraham and Isaac foreshadow in the New Testament?"
    answer: "Genesis 22 is widely understood as one of the clearest foreshadowings of the gospel in the Old Testament. A father offering his beloved son on a mountain, a substitute provided at the last moment, the place called 'the Lord will provide' — all of it points forward to God the Father offering His one and only Son Jesus as the substitute for humanity's sin."
  - question: "What does Genesis 22 teach about holding things with open hands?"
    answer: "Genesis 22 teaches that the things we love most are safest when held loosely — surrendered to the God who gave them. Abraham received Isaac back not because he gripped him tighter but because he was willing to release him completely. Holding the gifts of God with open hands is not about loving them less — it's about trusting the Giver more than the gift."
---
...
!["The Lord will provide" — Genesis 22:14|A stone cross standing on a mountain peak surrounded by clouds, trusting God with what you love most](/blog/genesis22-cross-mountain.webp)
...
!["God himself will provide" — Genesis 22:8|Starry night sky, God has already prepared provision before we arrive at the moment we need it](/blog/genesis37-stars.webp)
...
The mornings when God is asking you to trust Him with something you love are the mornings when you need an anchor in Scripture more than any other time. The [FaithSpark blog](/blog) or visit [faithspark.app](/) to learn more has devotionals for every season — and the [FaithSpark app](https://apps.apple.com/app/faithspark-ai-daily-devotional/id6761655724) delivers a personalized devotional every morning grounded in Scripture, meeting you in the specific place you are before the weight of the day settles in. Available now on [iOS](https://apps.apple.com/app/faithspark-ai-daily-devotional/id6761655724) and [Android](https://play.google.com/store/apps/details?id=com.mindgardenpress.faithspark&pcampaignid=web_share). Start each morning with open hands.
