...
export const metadata: Metadata = {
  ...
  description: 'Looking for a Christian take on AA daily reflections? Joey, author of the faith-based AA Daily Reflections book, shares how FaithSpark supports your recovery with Scripture and prayer.',
  alternates: { canonical: 'https://faithspark.app/aa-daily-reflections/' },
  openGraph: {
    title: 'AA Daily Reflections | A Faith-Based Approach for Today',
    description: 'Looking for a Christian take on AA daily reflections? Joey, author of the faith-based AA Daily Reflections book, shares how FaithSpark supports your recovery with Scripture and prayer.',
    url: 'https://faithspark.app/aa-daily-reflections/',
    images: [{ url: '/Faithspark1200x630.jpg', width: 1200, height: 630, alt: 'FaithSpark AA Daily Reflections' }],
  },
};
...
const S = {
  ...
  bookDesc: { fontSize: 15, color: '#6B7B6E', lineHeight: 1.7, marginBottom: 16 },
  bookLink: { color: '#C8762A', fontWeight: 700, fontSize: 14, textDecoration: 'none' },
  blockquote: { borderLeft: '3px solid #C8762A', paddingLeft: 24, margin: '32px 0', fontStyle: 'italic' as const, color: '#6B7B6E', fontSize: 18, lineHeight: 1.7 },
    ...
    <div style={S.page}>
      ...
      <article style={S.body}>
        ...
        <div style={S.ctaBox}>
          ...
          <p style={{ color: '#6B7B6E', fontSize: 13, marginTop: 16 }}>Or read the book: <a href="https://www.amazon.com/AA-Daily-Reflections-Book-Faith-Based-ebook/dp/B0DHFV6R5N" target="_blank" rel="noopener noreferrer" style={{ color: '#C8762A' }}>AA Daily Reflections: A Faith-Based Approach on Amazon</a></p>
        </div>
      </article>
