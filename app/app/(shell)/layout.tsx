...
const NAV_ITEMS = [
  ...
  { href: "/app/reading-plans/", icon: "🗺️", label: "Reading Plans", live: false },
  { href: "/app/prayer-board/", icon: "🙏", label: "Prayer Board", live: false },
  { href: "/app/journal/", icon: "📝", label: "Journal", live: false },
  { href: "/app/bible-study/", icon: "👨‍👩‍👧", label: "Bible Study", live: false },
