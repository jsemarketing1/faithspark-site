...
const S = {
  ...
  warningBox: { background: 'rgba(200,118,42,0.08)', border: '1px solid rgba(200,118,42,0.2)', borderRadius: 12, padding: '20px 24px', margin: '32px 0', fontSize: 15, color: '#6B7B6E', lineHeight: 1.7 },
  ...
  return (
    <div style={S.page}>
      ...
      <article style={S.body}>
        ...
        <ul style={{ paddingLeft: 24, color: '#2C3E30', lineHeight: 2, fontSize: 16, marginBottom: 20 }}>
        ...
        <div style={S.ctaBox}>
          ...
          <p style={{ color: '#6B7B6E', fontSize: 13, marginTop: 16 }}>Also available on the web at <a href="https://app.faithspark.app" target="_blank" rel="noopener noreferrer" style={{ color: '#C8762A' }}>app.faithspark.app</a></p>
        </div>
      </article>
